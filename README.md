...
* **Too long envelope, shrinked to 512** — .XI does not support envelopes longer than 512 tick (~10.24 seconds), so you instrument envelope was modified to fit this range
